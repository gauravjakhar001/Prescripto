...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 py-10'>
      ...
      {/* Doctors grid */}
      <div className='w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 pt-4'>
        {relDoc.slice(0, 5).map((item, index) => (
          <div
            key={index}
      ...
      <button
        ...
        className='mt-6 px-10 py-3 rounded-full text-sm font-medium transition-all duration-200 hover:-translate-y-0.5'
        style={{ border: '1.5px solid #e8eaf2', background: 'white', color: '#5a5f7a' }}
        onMouseEnter={e => {
